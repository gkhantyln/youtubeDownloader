...
class YouTubeDownloader:
    def __init__(self, video_id):
        ...
        self.target_folder = os.path.join(os.getcwd(), "audios")
    ...
    def download_audio(self):
        try:
            ...
            audio_filename = f"{cleaned_title}_{self.video_id}.mp3"
            ...
            options = {
                ...
                'outtmpl': os.path.join(self.target_folder, audio_filename),
            }
